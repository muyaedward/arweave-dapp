        ...
        <div class="sm:flex-1">
            ...
            <div id="content" class="bg-transparent px-8 py-6">
                <div id="content" class="relative">
                    ...
                    <div class="w-full">
                        <h1 class="text-3xl text-gray-800 font-semibold">Authors</h1>
                        <p>List all the authors/users who have submitted a paper. You can make a direct donation from here</p>
                    </div>                
                </div>
            </div>
        </div>    
